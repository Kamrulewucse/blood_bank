...
<body class="hold-transition login-page" style="background-image: url({{ asset('img/bg-login.jpg') }});background-size: contain;">
<div class="login-box">
    <!-- /.login-logo -->
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="{{ route('login') }}">
                <img height="100px" src="{{ asset('img/logo1.jpeg') }}" alt="">
            </a>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="input-group mb-3">
                    <input id="password" type="password" autocomplete="current-password" name="password" class="form-control" placeholder="Password">
                    <div id="password_show_hide" class="input-group-append">
                        <div id="password_icon" class="input-group-text">
                            <span style="font-size: 13px;" class="fas fa-eye-slash"></span>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<script>
    $("#password_show_hide").click(function(){
        ...
        {
            $("#password_icon").html('<span style="font-size: 14px;" class="fas fa-eye"></span>');
            passInput.attr('type','text');
        }else{
            $("#password_icon").html('<span style="font-size: 13px;" class="fas fa-eye-slash"></span>');
