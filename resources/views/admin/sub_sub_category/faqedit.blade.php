    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('sub_sub_category.faqedit',['subSubCategoryfaq'=>$subSubCategoryfaq->id]) }}" enctype="multipart/form-data" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="form-group row {{ $errors->has('question') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="3"  name="question" class="form-control" id="question" placeholder="Enter Short answer">{{$subSubCategoryfaq->question}}</textarea>
                                @error('question')
                        ...
                        <div class="form-group row {{ $errors->has('answer') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="3"  name="answer" class="form-control" id="answer" placeholder="Enter answer">{{$subSubCategoryfaq->answer}}</textarea>
                                @error('answer')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row {{ $errors->has('sort') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="number" value="{{ old('sort',$subSubCategoryfaq->sort) }}" name="sort" class="form-control" id="sort" placeholder="Enter Sort">
