    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" action="{{ route('slider.edit',['slider'=>$slider->id]) }}" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('short_description') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="3"  name="short_description" class="form-control" id="short_description" placeholder="Enter Short Description">{{ old('short_description',$slider->short_description) }}</textarea>
                        ...
                        <div class="form-group row {{ $errors->has('status') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="icheck-success d-inline">
                                    <input checked type="radio" id="active" name="status" value="1" {{ empty(old('status')) ? ($errors->has('status') ? '' : ($slider->status == '1' ? 'checked' : '')) :
                                ...
                                <div class="icheck-danger d-inline">
                                    <input type="radio" id="inactive" name="status" value="0" {{ empty(old('status')) ? ($errors->has('status') ? '' : ($slider->status == '0' ? 'checked' : '')) :
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('slider') }}" class="btn btn-default btn-flat float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
