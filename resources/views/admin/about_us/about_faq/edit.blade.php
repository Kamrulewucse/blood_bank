                ...
                <form action="" enctype="multipart/form-data" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group row {{ $errors->has('question') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="3"  name="question" class="form-control" placeholder="Enter Question">{{ old('question',$AboutFaq->question ) }}</textarea>
                                @error('question')
                        ...
                        <div class="form-group row {{ $errors->has('answer') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="3"  name="answer" class="form-control" id="answer" placeholder="Enter answer">{!! old('answer',$AboutFaq->answer ) !!}</textarea>
                                @error('answer')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
