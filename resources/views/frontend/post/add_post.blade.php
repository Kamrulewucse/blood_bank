        ...
        <div class="row ">
            <div class="col-lg-12 text-center">
                <div class="about-text go-to">
                    <h2 class="blood-color">Create Post For Blood</h2>
                    <hr>
                </div>
            </div>
            <div class="col-lg-3"></div>
            <div class=" col-lg-6">
                <form class="" action="{{route('add_post')}}" method="post" id="user-login" accept-charset="UTF-8" role="form">
                    @csrf
                    <div class="form-body">
                        <div class="form-wrapper" id="edit-credentials">
                            <div class="form-item form-group form-type-textfield form-item-name {{ $errors->has('blood_for') ? 'has-error' :'' }}">
                             ...
                             <div id="others_field">
                                 ...
                                 <div class="form-item form-group form-type-textfield form-item-first-name {{ $errors->has('patient_name') ? 'has-error' :'' }}">
                                    ...
                                    <input autocomplete="given-name" type="text" placeholder="Enter your name" name="patient_name" class="form-text form-control" />
                                    @error('patient_name')
                                    <span class="help-block text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-item form-group form-type-textfield form-item-first-name {{ $errors->has('date_blood_needed') ? 'has-error' :'' }}">
                                ...
                                <input autocomplete="given-name" type="date"  name="date_blood_needed" value="" size="60" maxlength="128" class="form-text form-control" />
            ...
            <script>
                ...
                $(function () {
                    ...
                    $('#district').change(function () {
                        ...
                        $('#sub_sub_category').html('<option value="">Select Upazila</option>');
